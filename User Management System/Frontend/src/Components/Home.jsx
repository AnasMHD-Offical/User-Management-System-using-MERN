import {
  ...
  const navigation = [
    ...
    // { name: "User Management", href: "/adminpanel", current: false },
        ...
        <div className="min-h-full">
          ...
          <header className="bg-white shadow">
            <div className="mx-auto max-w-7xl sm:flex justify-between px-4 py-6 sm:px-6 lg:px-8">
              ...
              {/* <div className="border-2 align-middle p-2 mt-4 sm:mt-0">
            ...
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 md:flex">
              ...
              <div className="border-2 md:w-1/4 flex flex-col p-2 py-5 ">
                ...
                <div className="m-2">
                  ...
                  <p className="text-lg font-medium">Email : {name}</p>
                  <p className="text-lg font-medium">Phone : {name}</p>
                  <p className="text-lg font-medium">Designation : User</p>
                </div>
                <button className="rounded-r-lg rounded-l-lg bg-rose-600 py-2 px-3 text-white">
                  Logout
                </button>
              </div>
            </div>
