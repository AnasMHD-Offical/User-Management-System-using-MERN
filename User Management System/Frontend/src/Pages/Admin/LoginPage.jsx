...
import { setAdminData } from '../../Store/Slices/AdminSlice';
    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-sky-50">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                className="block w-full rounded-md border-2 bg-sky-50 border-sky-950 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          ...
          <Link to={"/admin/signup"} className="font-semibold leading-6 text-sky-600 hover:text-sky-500">
            Create an account
          </Link>
        </p>
      </div>
